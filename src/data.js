const menu = [
  ...
  },
  {
    ...
    version: '0.1',
    description:
      'Script pour comptabiliser correctement les réussites de jets sur le JdR Imperator (de JdR Editions).\r\rPour des instructions, saisissez `!imperator --help`.',
    author: 'Kapirklaa',
  },
  {
    modid: 108,
  ...
  },
  {
    ...
    version: '1.0',
    description:
      "Il s'agit du script pour accompagner la fiche de personnage de Knight, afin d'afficher des status sur les tokens, et de prévenir lorsqu'un personnage change de style de combat.\r\r**Commandes :**\r*...",
    author: 'Alain H.',
  },
  {
    modid: 114,
    ...
    version: '1.0',
    description:
      'Script pour le Jeu de Rôle Krystal, édité par Les XII Singes.\r Permet de lancer des dés Krystal (dK) et de sommer le résultat correctement. Les 1, 3 et 6 seront ajoutés au total et affichés en vert. L...',
    author: 'Elsa T.',
  },
  {
    modid: 115,
  ...
  },
  {
    ...
    version: '1.0.0',
    description:
      "Unofficial polish version of Seth Williams' script to speed up combat. // Nieoficjalna polska wersja skryptu przyspieszającego walkę WFRP 4ed",
